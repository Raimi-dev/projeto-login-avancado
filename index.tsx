...
type TextInputProps = {
    ...
    iconRight?: string,
    label?: string,
    labelClasseNames?: string,
    subDescription?: string | React.ReactNode
} & React.InputHTMLAttributes<HTMLInputElement>

const TextInput = ({iconLeft, iconRight, subDescription, labelClasseNames, label, ...props }: TextInputProps) => {
...
const mergedLabelClasses = twMerge(defaultLabelClasses, labelClasseNames)
